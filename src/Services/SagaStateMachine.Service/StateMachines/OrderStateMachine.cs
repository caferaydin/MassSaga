...
namespace SagaStateMachine.Service.StateMachines
{
    ...
    {
        public Event<OrderStarterEvent> OrderStartedEvent { get; set; }
        ...
        public OrderStateMachine()
        {
            ...
            (
                When(OrderStartedEvent)
                    ...
                    .Send(new Uri($"queue:{Shared.Settings.RabbitMqSettings.Stock_OrderCreatedEventQueue}"),
                        context => new OrderCreatedEvent(context.Instance.CorrelationId)
                        {
                            OrterItems = context.Data.OrderItems,
                        })
            );
            ...
            During(OrderCreated,
                When(StockReservedEvent)
                    ...
                    .Send(new Uri($"queue:{Shared.Settings.RabbitMqSettings.Payment_StartedEventQueue}"),
                ...
                When(StockNotReservedEvent)
                    ...
                    .Send(new Uri($"queue:{Shared.Settings.RabbitMqSettings.Order_OrderFailedEventQueue}"),
            ...
            During(StockReserved,
                When(PaymentCompletedEvent)
                    ...
                    .Send(new Uri($"queue:{Shared.Settings.RabbitMqSettings.Order_OrderCompletedEventQueue}"),
                ...
                When(PaymentFailedEvent)
                    ...
                    .Send(new Uri($"queue:{Shared.Settings.RabbitMqSettings.Stock_RollbackMessageQueue}"),
